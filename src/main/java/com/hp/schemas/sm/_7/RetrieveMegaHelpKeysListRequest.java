 ...
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="model" type="{http://schemas.hp.com/SM/7}MegaHelpModelType"/&amp;gt;
 *       &amp;lt;/sequence&amp;gt;
...
@XmlRootElement(name = "RetrieveMegaHelpKeysListRequest")
public class RetrieveMegaHelpKeysListRequest {

    @XmlElement(required = true)
    protected MegaHelpModelType model;
     ...
     * @return
     *     possible object is
     *     {@link MegaHelpModelType }
     *     
     */
    public MegaHelpModelType getModel() {
        return model;
    }
     ...
     *     
     */
    public void setModel(MegaHelpModelType value) {
        this.model = value;
    }
