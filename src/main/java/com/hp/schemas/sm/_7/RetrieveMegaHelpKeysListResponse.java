 ...
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="keys" type="{http://schemas.hp.com/SM/7}MegaHelpKeysType" maxOccurs="unbounded"/&amp;gt;
...
@XmlRootElement(name = "RetrieveMegaHelpKeysListResponse")
public class RetrieveMegaHelpKeysListResponse {

    @XmlElement(required = true)
    protected List<MegaHelpKeysType> keys;
     ...
     * 
     */
    public List<MegaHelpKeysType> getKeys() {
        if (keys == null) {
            keys = new ArrayList<MegaHelpKeysType>();
        }
        return this.keys;
    }
