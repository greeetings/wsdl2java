 ...
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element name="instance" type="{http://schemas.hp.com/SM/7}MegaHelpInstanceType" maxOccurs="unbounded"/&amp;gt;
...
@XmlRootElement(name = "RetrieveMegaHelpListResponse")
public class RetrieveMegaHelpListResponse {

    @XmlElement(required = true)
    protected List<MegaHelpInstanceType> instance;
     ...
     * 
     */
    public List<MegaHelpInstanceType> getInstance() {
        if (instance == null) {
            instance = new ArrayList<MegaHelpInstanceType>();
        }
